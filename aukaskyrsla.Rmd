...
``` {r}
eigenX$values 
# Sjáum að eigingildi 16 er pínkulítið XXX ATHUGA, BREYTA 14 í 16
eigenX$vectors[, 16]
colnames(data[numericNames])[c(5, 6, 10, 12, 13)]
sum(eigenX$vectors[c(5, 6, 10, 12, 13), 16])
sum(eigenX$vectors[,16])
plot(eigenX$vectors[c(5, 6, 10, 12, 13),16])
bad_actors <- eigenX$vectors[c(5, 6, 10, 12, 13), 16]
...
```
Hér er augljóslega tilfelli af hederoskedaticity, XXX MISDREIFNI þ.e. leifðin eykst með hærra spágildi.Við ættum að geta séð þetta vel líka með QQ-plotti af leifðinni:
